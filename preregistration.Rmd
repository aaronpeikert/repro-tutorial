...
if(simulated){
  cat("\\textcolor{red}{The results are based on simulated data and must not be interpreted. They only serve to illustrate the result of the preregistered code.}")
  set.seed(1234)

...
if(simulated){
  ...
  mach <- readr::read_delim(real_data, delim = "\t")
...
After we have acquired the data, we realized that we had to change the code for reading the data (see commit [6556a93](https://github.com/aaronpeikert/repro-tutorial/commit/6556a9395fcdd600b5b0c5358f92a2c6635ae360)).

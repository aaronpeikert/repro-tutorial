...
\pubyear{2019}
\copyrightyear{2019}
\externaleditor{Academic Editor: {Alexander Robitzsch}} %MDPI: Please add the academic editor.
\datereceived{} 
\dateaccepted{} 
\datepublished{}
...
Thing More \highlighting{Than Once}} %MDPI: the article type in the document is different with that in Susy, please confirm.
...
\Author{\highlighting{Aaron Peikert~$^{1,2,*}$\href{https://orcid.org/0000-0001-7813-818X}{\orcidicon}} %Please carefully check the accuracy of names and affiliations. Changes will not be possible after proofreading.
, \highlighting{Caspar J. van Lissa~$^{3,4}$\href{https://orcid.org/0000-0002-0808-5024}{\orcidicon}} %MDPI: This author is different from susy. Please check.
...
$^{2}$ \quad Humboldt-Universität zu Berlin, \hl{Berlin}, Germany\\%MDPI: Please add the post code.
$^{3}$ \quad \hl{Department} of Methodology \& Statistics---Utrecht \hl{University}, \hl{Faculty} of Social and Behavioral Sciences%MDPI: Please check the address order.  (order guide: Center / Laboratory / Group / Programme / Unit < Department / Division / Faculty / Campus / Institute / School < College / University / Universiti)
, \hl{Utrecht}, The Netherlands; C.J.vanLissa@uu.nl\\
$^{4}$ \quad Open Science Community Utrecht, \hl{Utrecht}, The Netherlands\\
$^{5}$ \quad Max Planck UCL Centre for Computational Psychiatry and Ageing Research, \mbox{\hl{Berlin, Germany, and London, UK}} %MDPI: 1. Please check if there are two separator affiliations. If so, please split them. 2. Please add the post code.
\\
$^{6}$ \quad MSB Medical School Berlin, \hl{Berlin}, Germany}
...
R; R Markdown; make; GitHub; docker}%MDPI: 1. The upper case has been removed. Please confirm. 2. Please check if R is duplicated here.
...
\emph{same} data with the \hl{\emph{same}} %MDPI: Is the italic necessary? Can it be deleted?
 computer code (see~\citep{Peikert2019} \hl{for
details).} %MDPI: The structure of reference citation has been changed. So as the follows. Please confirm.
...
%\tightlist
\item
  \highlighting{\emph{Multiple inconsistent versions of code, data, or both};} %MDPI: Is the italic necessary? Can it be deleted?
 for
...
\item
  \highlighting{\emph{Copy-and-paste errors};} for example, results are often manually
...
\item
  \highlighting{\emph{Undocumented or ambiguous order of computation};} for example,
  ...
  another).
\item
  \highlighting{\emph{Ambiguous software dependencies};} for example, a given analysis
...
intermediate %pls check (such as preprocessed data files, simulation
...
tiny (the \hl{\texttt{Dockerfile}} %MDPI: Please add the accessed date.
...
components (see \highlighting{Figure~\ref{figure1})} %MDPI: Figure 2.1 has been changed into Figure 1. Please confirm.
...
\hl{installation advice} %MDPI: Please add the accessed date.
...
interface in the RStudio \texttt{Git} pane (see \highlighting{Figure~\ref{figure2}).} %MDPI: Figure 3.1 has been changed into Figure 2. Please confirm.
 Click on
...
preregistered plan, e.g.~in the discussion of the \hl{final manuscript} %MDPI: Footnote is not allowed in this journal. The content has been moved here. Please confirm.
...
supplementary materials}% MDPI: Please add the accessed date.
...
objective. Packages like {\texttt{pander}}
(\url{https://github.com/Rapporter/pander})
\citep{pander}, {\texttt{stargazer}}
\mbox{(\url{https://cran.r-project.org/web/packages/stargazer/vignettes/stargazer.pdf})}
\citep{stargazer}, {\texttt{apaTables}}
(\url{https://dstanley4.github.io/apaTables/articles/apaTables.html})
\citep{apaTables} and {\texttt{papaja}}
\mbox{(\url{http://frederikaust.com/papaja_man/})}
\citep{papaja} help you to create dynamically generated professional
looking results. The package {\texttt{report}}
(\url{https://github.com/easystats/report})~\citep{report} is particularly noteworthy because it not only generates
...
\begin{quote}
\hl{Navigate to} %MDPI: Please add the accessed date.
...
\begin{quote}
Log into zenodo.org → Account → \hl{GitHub} %MDPI: 1. Footnote is not allowed in this journal. The content has been moved here. Please confirm. 2. Please add the accessed date
...
is available in the \hl{online supplementary material}%MDPI: Please add the accessed date.
...
are familiar \hl{with it} %MDPI: Footnote is not allowed. The content has been moved here. Please confirm.
...
Carlo simulation for this example are visualized in \highlighting{Figure~\ref{figure3}.} %MDPI:  Figure 5.1 has been changed into Figure 3. Please confirm.
 The code
...
recoding of gender (lines 17--22) and the items\hl{ (lines 23--26).} %MDPI: Footnote is not allowed. The content has been moved here. Please confirm.
 ({We
  invite the reader to evaluate the changes we made to the preregistered
  code. Either on \hl{GitHub}
  (\url{https://github.com/aaronpeikert/repro-tutorial/compare/v0.0.1.1-prereg...main})
...
Supplementary Materials{\hl{\quad \quad}}%The following are available online at www.mdpi.com/xxx/s1, Figure S1: title, Table S1: title, Video S1: title.
...
\funding{\hl{\quad \quad}} %This research received no external funding'' or ``This research was funded by NAME OF FUNDER grant number XXX.'' and  and ``The APC was funded by XXX''. Check carefully that the details given are accurate and use the standard spelling of funding agency names at \url{https://search.crossref.org/funding}, any errors may affect your future funding.}

\institutionalreview{\hl{\quad \quad}} %In this section, please add the Institutional Review Board Statement and approval number for studies involving humans or animals. Please note that the Editorial Office might ask you for further information. Please add ``The study was conducted according to the guidelines of the Declaration of Helsinki, and approved by the Institutional Review Board (or Ethics Committee) of NAME OF INSTITUTE (protocol code XXX and date of approval).'' OR ``Ethical review and approval were waived for this study, due to REASON (please provide a detailed justification).'' OR ``Not applicable'' for studies not involving humans or animals. You might also choose to exclude this statement if the study did not involve humans or animals.

\informedconsent{\hl{\quad \quad}} %Any research article describing a study involving humans should contain this statement. Please add ``Informed consent was obtained from all subjects involved in the study.'' OR ``Patient consent was waived due to REASON (please provide a detailed justification).'' OR ``Not applicable'' for studies not involving humans. You might also choose to exclude this statement if the study did not involve humans. Written informed consent for publication must be obtained from participating patients who can be identified (including by the patients themselves). Please state ``Written informed consent has been obtained from the patient(s) to publish this paper'' if applicable.

\dataavailability{\hl{\quad \quad}} %In this section, please provide details regarding where data supporting reported results can be found, including links to publicly archived datasets analyzed or generated during the study. Please refer to suggested Data Availability Statements in section ``MDPI Research Data Policies'' at \url{https://www.mdpi.com/ethics}. You might choose to exclude this statement if the study did not report any data.
...
The R package \texttt{repro} was developed as part of the \hl{first author's
master thesis}
\mbox{(\url{https://aaronpeikert.github.io/repro-thesis/})} at the Humboldt-Universität zu Berlin.}
...
Knuth, D.E.; Levy, S. \emph{The CWEB System of Structured Documentation}; Addison-Wesley Longman: \hl{Boston, USA, 1994.}%MDPI: Please add the publisher’s location.
...
Brandmaier, A.M.; Jacobucci, R. Machine-Learning Approaches to Structural Equation Modeling. In \emph{Handbook of Structural Equation Modeling}, 2nd ed.; Hoyle, R.H., Ed.; \hl{Guilford Press, New York, NY, USA}, in press.%MDPI: Please add the location of the publisher and publication year.

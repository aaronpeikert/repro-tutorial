...
Thing More \highlighting{Than Once}}
...
\Author{\highlighting{Aaron Peikert~$^{1,2,*}$\href{https://orcid.org/0000-0001-7813-818X}{\orcidicon}}
, \highlighting{Caspar J. van Lissa~$^{3,4}$\href{https://orcid.org/0000-0002-0808-5024}{\orcidicon}}
...
$^{3}$ \quad \hl{Department} of Methodology \& Statistics---Utrecht \hl{University}, \hl{Faculty} of Social and Behavioral Sciences
, \hl{Utrecht}, The Netherlands; C.J.vanLissa@uu.nl\\
$^{4}$ \quad Open Science Community Utrecht, \hl{Utrecht}, The Netherlands\\
$^{5}$ \quad Max Planck UCL Centre for Computational Psychiatry and Ageing Research, \mbox{\hl{Berlin, Germany, and London, UK}}\\
...
%\tightlist
\item
  \highlighting{\emph{Multiple inconsistent versions of code, data, or both};}
 for
...
components (see \highlighting{Figure~\ref{figure1})}
...
interface in the RStudio \texttt{Git} pane (see \highlighting{Figure~\ref{figure2}).}
 Click on
...
Carlo simulation for this example are visualized in \highlighting{Figure~\ref{figure3}.}
 The code
...
recoding of gender (lines 17--22) and the items\hl{ (lines 23--26).}
We invite the reader to evaluate the changes we made to the preregistered code. Either on \hl{GitHub} (\url{https://github.com/aaronpeikert/repro-tutorial/compare/v0.0.1.1-prereg...main})

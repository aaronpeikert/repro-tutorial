...
if (!file.exists(readme)) {
  webshot2::webshot(
    ...
    file = readme,
    vwidth = 1920,
    # height & width are not resolution
    vheight = 1080,
    # but what website thinks the browser size is
    selector = "div#readme",
    zoom = 2
  ) # higher resolution
}
...
```{r, include=FALSE}
knitr::write_bib(c(.packages(), "rticles", "gert", "bookdown", "lavaan", "knitr", "targets", "renv", "tidyverse"),
                 "packages.bib")
```

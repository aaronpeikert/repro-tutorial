...
Both steps are linked by manually copying and pasting results from one software to the other; a process that often produces in inconsistencies [@nuijtenPrevalenceStatisticalReporting2016].

...
```{r}
res <- read_csv(here::here("results.csv"), col_types = "ddddd")
```
...
Ideally, all data is also stored in the repository.
In practice, however, there are various reasons, which may prohibit you from making your data available, for example legal or regulatory or privacy concerns.

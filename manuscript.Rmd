...
To prevent Git from accidentally committing files or you do not want to track you can use the `.gitignore`, for example:

```{r}
usethis::use_git_ignore("private.md")
```

We activate Git in any project with:

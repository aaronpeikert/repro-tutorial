...
We suggest using Markdown for everything, starting from simple sketches of your ideas to your scientific manuscripts[@R-rticles] and presentations[@revealjs]---and even your CV [@vitae].
...
One solution to the problem of external software dependencies is to provide not only the analysis script but all dependent software packages and system libraries in a so-called _container_.

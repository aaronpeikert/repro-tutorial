...
To make the comparison even more accessible, we highly recommend that the authors review all changes made to the preregistered plan to summarize and justify them for their reader, e.g. in the discussion of the final manuscript [^summarize-changes].

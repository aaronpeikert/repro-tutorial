...
The complete example is available in the (https://github.com/aaronpeikert/repro-tutorial/blob/main/preregistration.Rmd).
In this section, we show excerpts of this example formatted in light grey and provide some commentary.

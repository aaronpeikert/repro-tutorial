...
Note that the Workflow for Open Reproducible Code in Science (WORCS) we presented elsewhere [@vanlissa2020worcs] relies for software management on the R package `renv`[@R-renv] which is more lightweight and easier to use on the one hand, but not as comprehensive on the other hand because it only snapshots the R packages instead of all software used.

...
Some may see the rigidness of PAC as to much of a good thing.
However, we are convinced that many reasons justify changing the preregistered code, but we are equally convinced that readers should judge themselves if they find these deviations from the preregistration meaningful.

...
Such files are tiny (the [Dockerfile](https://github.com/aaronpeikert/repro-tutorial/blob/main/Dockerfile) for this project is `r round(as.numeric(fs::file_size("Dockerfile"))/1024^1, 2)`Kb big) and are an sufficently describe how to recreate a given container image.
...
This snipped installs python, added to `.repro/Dockerfile_manual` you get an image that has python available:

...
While such argument has some merits, we believe another advantage of preregistration is transparency.
...
A preregistration, together with version control allows their readers to inform themselfs about these lessons learned.
...
First dependency management, which means that you capture the interrelations between the components of your analysis.

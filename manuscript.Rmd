...
Often a preregistration is guided by a template, which formalizes the research questions and the planned analysis.
An alternative to such protocol is to submit preregistration as code.
Therefore, instead of describing the analysis that you plan to turn into code and run, you write the code beforehand.
This is obviously challenging to do, because it is so concrete.

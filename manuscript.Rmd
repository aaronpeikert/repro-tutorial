...
Typically, it is recommended to choose conservative values during study design planning  [@brandmaier2018precision].
...
As a heuristic guess, we assume that the factor loadings are 30% lower than reported and that the standardized mean difference is only 0.2.
...
Structural Equation Models are generative models that not only fit models but lend themselves to data simulation. This is particularly easy in lavaan syntax using the function `simulateData`.

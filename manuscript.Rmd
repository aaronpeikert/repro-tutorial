...
In fact, till after we preregistered the study `r link("https://github.com/aaronpeikert/repro-tutorial/releases/tag/ v0.0.1-preregistration", "preregistration")` were the results below based on simulated data.

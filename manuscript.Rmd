...
If not declared otherwise the code is meant to run in R (version `r with(R.version, paste0(major, ".", minor))`).
...
Ideally, you ask a coworker or collaborator to reproduce the project independently from you.

...
These open repositories do not routinely provide sufficient information to reproduce relevant computational and statistical results.
...
A PAC offers four advantages over classical preregistration.
...
One the one hand, preregistrations are plagued by nonreproducibility like any other research outcome.
...
On the other hand have PACs greater requirements for reproducibility than a simple analysis script.
A reproducible script is supposed to work on the same data at a later point in time.
PAC requires a script to work on different data at a later point in time, a property we call "reusability".
...
Reusability promises a wide range of applications, among them PAC [possibly submitted as a registered report @nosekRegisteredReports2014; @chambersWhatNextRegistered2019], Direct Replication[@simonsValueDirectReplication2014], fully automated living metanalysis [@elliottLivingSystematicReviews2014], Executable Research Articles [@elifesciencespublicationsELifeLaunchesExecutable2020], and other innovations like the live analysis of born open data [@rouderWhatWhyHow2016; @kekecsRaisingValueResearch2019].

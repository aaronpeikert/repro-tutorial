...
However, which tools you use to implement this concepts are mere matter of taste and project requirements.
...
```{r idea-change, echo=FALSE, fig.cap="A screenshot of how a change tracked in Git is represented by GitHub.  "}

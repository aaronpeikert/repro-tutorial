...
```{r}
# define a ürint method for objects of the class data.frame
...
Packages like [`stargazer`](https://cran.r-project.org/web/packages/stargazer/vignettes/stargazer.pdf)[^stargazer], [`apaTables`](https://dstanley4.github.io/apaTables/articles/apaTables.html)[^apaTables] [citation] and [`papaja`](http://frederikaust.com/papaja_man/)[^papaja] help you to create dynamically generated professional looking results.
...
An compromise between making the data publicly available and keeping it closed is to publish synthetic data [@vanlissa2020worcs].

...
Ideally, all data is also stored in the repository [for a more comprehensive argument for publishing data see @vanlissa2020worcs] and well documented [@codebook], but this is not always feasible.

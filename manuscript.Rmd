...
For convenience, we use the [`gert`-package](https://github.com/r-lib/gert) [@R-gert] to interface with Git, but it does not make a difference:
...
gert::git_add("add a first concept")
```

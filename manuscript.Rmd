...
Beyond ensuring that the code runs without technical error and it lets you form more realistic expectations about the estimates' correctness and precision.
...
If you are unfamiliar with the specifics of SEM, you may briefly skim the next sections and continue in section ["Randome Number Generation"](#prng).
...
In fact, this manuscript and therefore the here presented Machiavialismus example were preregistered as a full manuscript, and you can see the results on real data in section [Reproduce a Project].

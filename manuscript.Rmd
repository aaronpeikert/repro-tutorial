...
simplesummary: |
  ...
  A scientific analysis is called reproducible when an independent person obtains the same results from the same data. <!--AB something seems to generic; we could generalize this to digital objects, though-->

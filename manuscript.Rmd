...
To some extent these potential benefits are contingent on whether these digital research artifacts are reproducible. <!--CJ Define reproducibility here-->
...
This is because making a research project with all code, data, and materials reproducible comes with a variety of challenges, and there is a dire need for reproducibility standards.<!-- CJ Are we introducing such standards? Otherwise, that comment belongs in the Discussion, as a recommendation for future work. Also, if there are no standards - then how do we know repro meets the required goals?-->
<!-- CJ This is superfluous; the technology has existed for a while: We now have the technology to make all artefacts related to a research project available so that a research project can be reproduced with minimal effort.-->
...
We pursue two aims.
First, the present paper introduces the reader to a workflow that maximizes the potential reproducibility of a research project.<!--CJ: Start new sentence. Ensures reproducibility...by eliminating threats to reproducibility is an awkward sentence construction-->
This workflow builds on several technical solutions originating in the software engineering community. 
We discuss how the workflow addresses four common threats to reproducibility [see @Peikert2019 for details].
...
PAC involves preregistering the intended analysis code and the bulk of the manuscript as dynamic document, including the Introduction, Methods, and Results sections<!--CJ Preregistration may occur at different stages, including after data collection:, before they gather empirical data.-->
...
<!-- CJ This is a repetition: PAC serves as unambiguous preregistration of the planned analysis and how the results are going to be reported.-->
...
PAC has the potential to all but eliminate researchers degrees of freedom that standard preregistration afford.

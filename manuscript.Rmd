...
One of the greatest benefits of open research is that other people can freely reuse your materials.
...
The `README.md` file will look pleasant in the browser, just like in Figure \@ref(fig:idea-change).
...
webshot2::webshot("https://github.com/aaronpeikert/repro-tutorial/",
                  file = readme,
                  selector = "div#readme",
                  zoom = 1)# higher resolution
```

```{r readme, echo=FALSE, fig.cap="A screenshot of how a change tracked in Git is represented by GitHub.  ", out.width='100%'}
...
That is because in many countries (i.e. the USA) the creator of something has exclusive right to use their creation.
...
To communicate that contributors can expect a welcoming and respectful environment, you can add the `r link( "https://www.contributor-covenant.org", "Contributor Covenant")`.
The Contributor Covenant is the code of conduct used by many open source project.

...
RStudio's _R Projects_ facilitate this concept of a project folder. The `repro` package offers an R Studio template, which sets up a file structure that follows best practices and conventions.<!--AP this is from your thesis - can you please add citations as to which practices and conventions these are?-->
...
This allows the creation of conditional text blocks, statistical results, or figures that are guarantueed to be uptodate because they are created everytime anew as the document is rendered to its output format (e.g., presentation slides or a journal article).
...
If you have simulated data, you could even already generate all figures and statistical results based on fake data, which will later be replaced by the real data.

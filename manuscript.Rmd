...
The `README.md` file will look pleasant in the webbrowser, just like in Figure \@ref(fig:idea-change).
...
webshot2::webshot("https://github.com/aaronpeikert/repro-tutorial/",
                  file = readme,
                  selector = "div#readme", # only select file change
...
However, if they contribute to the project, after you have added a license, they give their consent by contributing.
To add a license to your project simply run:

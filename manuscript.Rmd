...
For this technical check researcher do not necessarily have to simulated data, they could also rely on synthetic data.
Synthetic data means that they apply measures to obfuscate true relations in the data, e.g. shuffle the main dependent variable etc.
...
A single simulated or synthesized dataset already helps to ensure that the plan is viable under certain cirumstances.

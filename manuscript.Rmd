...
To make the comparison easier, we highly recommend that the authors review all changes to summarize and justify them for their reader [^summarize-changes].
...
And often deviations provide opportunity to learn from the unexpected.
Another reason why transparency is important in this regard, is that an empirical test of an theory can not test the theory alone but tests it in conjunction with auxiliary assumption [@meehlTheoreticalRisksTabular1978].
...
Another researcher, however, who, e.g. hopes to incorporate their results into a theory about intelligence, might disagree about the importance of this assumption and would accordingly view the finding as more explorative because of the change to the preregistrations.
...
Again such exploratory results should merely be explicitly declared in the manuscript to allow appropriate judgment of the results.
In fact, PAC allows to preregister exploratory statistical models.
Such preregistration communicates clearly how much exploration was going on, an information that is crucial for assessing the uncertainty of such results.

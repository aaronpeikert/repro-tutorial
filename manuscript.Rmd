...
If the hypotheses pertain to associations between variables, this treatment should thus be sufficient to revent cross-contamination.
...
<!-- CJ: This is really a different issue. You should not bring it up in relation to alternatives to simulated data. Preregistration after data collection is common for secondary data analysis of data obtained by other research groups [@westonRecommendationsIncreasingTransparency2019] but not so much within the same research project.
...
However, we must warn our readers, that while piloting is more traditional than our approach of blinding the data before preregistration, it is not innocuous to use the data resulting from the pilot study.<!--CJ What do you mean: innocuous!?-->
...
<!-- This is all repetition of the rest of the paper. Cut it.
...
<!--CJ I would skip this. It is a recommendation rooted in computer science, but without explaining it further, resears will not understand the motivation. Computational steps that apply to multiple analyses should be extracted into their own function, for example, those that perform data cleaning or extract results from a statistical model in an identical way.-->
...
After researchers are satisfied with their draft preregistration, they should archive a time-stamped and indelible version of the project that serves as the preregistration.
...
Third, the move towards open software for research offers several benefits beyond enabling automated reproducibility [@schaffnerFutureScientificJournals1994; @fitzgeraldTransformationOpenSource2006; @chaldecottHistoryScientificTechnical1965; @sonnenburgNeedOpenSource2007].<!--CJ Summarize these.-->

...
In practice, dependencies between project files (the raw data was preprocessed) or on external software (such as system libraries or components of the programming language) are frequently unmentioned.
...
One solution to problem of exteranal software dependencies is to provide not only the analysis script but all dependent software packages and system libraries in a so-called _container_.

...
They then request that you (or anyone with write permissions) "pull" these changes.
Any new pull request can be seen on GitHub:

``` r
usethis::browse_github_pulls()
```

Before you incorporate changes from someone else, you can review and change them.

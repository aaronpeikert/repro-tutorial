...
We have eveloped a workflow that leverages established tools and practices from software engineering to achieve long-term computational reproducibility of scientific data analyses resting on four pillars that address the aforementioned causes of non-reproducibility [@Peikert2019]:
...
This tutorial follows the recommendations of @Peikert2019 and use Git for version control, R Markdown for dynamic document creation, Make for dependency tracking, and Docker for software management.
...
If these commands detect that something is not installed or set up properly, they will alert you and give you detailed instructions (tailored to your operating system) to set up your computer.
Please make sure that all these commands pass before you continue with the tutorial.

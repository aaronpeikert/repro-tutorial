...
But these templates can not remove researchers degrees of freedoms completely, because it is impossible to describe every minute detail of an analysis for all but the simplest analysis with natural language.
...
PAC has the potential to all but eliminate researchers degrees of freedom.
...
@bakkerRecommendationsPreregistrationsInternal2020 found that, among the 210 preregistrations they investigated, 174 (67%) included a formal power analysis but from these only 34 (20%) provided enough information to theoretically reproduce the power analysis (they did not try to reproduce these in practice).
...
We want to extend PAC from preregistering code to preregistering *the whole manuscript as dynamic document*.

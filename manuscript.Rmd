...
<!--AP: I think this Figure is superfluous. Please remove. All the information is in the following code blocks.-->
...
Ideally, all data are also stored well documented [@codebook] in the repository [for a more comprehensive argument for publishing data see @vanlissa2020worcs], but this is not always feasible.

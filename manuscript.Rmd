...
One could even make a commit labelled "Necessary deviations from the preregistration after data collection",
...
With PAC, the authors can reflect any deviations with ease and should summarize and justify the changes for their readers [^summarize-changes].
The reader is also in a position to inspects the changes and can therefore make an informed judgment about weighing the evidence presented by the authors.

Take the following example: A preregistration intended to include "working memory" and "fluid intelligence" as predictors for reaction time in an experiment. However, after fitting the model on the actual data both constructs exhibit high collinearity.
...
Another researcher, however, who, e.g. hoped to incorporate their results into a theory about intelligence, might disagree about the importance of this assumption and would accordingly view the finding as more explorative because of the change to the preregistrations.
...
Similarly, preregistration, or PAC, does not preclude exploratory analyses but should demark confirmatory results.

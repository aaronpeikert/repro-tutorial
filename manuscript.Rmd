...
This tutorial follows the recommendations of @Peikert2019 and utilize Git for version control, RMarkdown for dynamic document creation, Make for dependency tracking, and Docker for software management.
...
For that or any other reason, you may want to adapt the Contributor Covenant, to fit the needs of you project (which you are allowed to to because it is published with a CC-BY license).

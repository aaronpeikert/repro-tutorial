...
A GUI has the apparent disadvantage for reproducibility that it requires a user who clicks on the correct elements (such as buttons or menu items) in the correct order.<!--AB not sure about the entire paragraph about CLI vs GUI here -  can we shorten this?-->
...
If you made changes to a file, you have to stage and then commit these changes (this is the basic save action for a project snapshot).
